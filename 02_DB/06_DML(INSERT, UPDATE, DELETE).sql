...
UPDATE DEPARTMENT2 
SET DEPT_ID = 'DO', DEPT_TITLE = '전략기획2팀'
WHERE DEPT_ID = 'D9';
...
-- EMPLOYEE2, DEPARTMENT2, LOCATION 사용
...
SELECT * FROM EMP_M01; 
SELECT * FROM EMP_M02; -- EMP_M01과 겹치는 행 4행, 겹치치 않는 행 1행

UPDATE EMP_M02 SET SALARY = 0; -- EMP_M02의 SALARY를 모두 0으로 수정
