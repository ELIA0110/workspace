...
/* 자료형
    ...
    CLOB : 대용량 문자 데이터 (4GB) (Character Long Og Byte)
*/
...
--    DEFAULT : 기본값
CREATE TABLE MEMBER(MEMBER_ID VARCHAR2(20), MEMBER_PWD VARCHAR2(20),
					MEMBER_NAME VARCHAR2(60), MEMBER_SSN CHAR(14),-- 주민번호는 항상14글자
...
COMMENT ON COLUMN MEMBER.MEMBER_SSN IS '주민등록 번호';
...
INSERT INTO MEMBER 
VALUES('MEM01', '123ABC', '홍길동', '991101-1234567', DEFAULT);
...
/*
    ...
    FOREIGN KEY(다른 테이블의 기본키 또는 UNIQUE가 설정된 칼럼을 참조).
    		-> 다른 테이블의 값을 가져다 씀
    		-> 두 테이블이 같은 값을 가지는 컬럼을 생기게 됨
    		-> JOIN 가능 ====== 관계 형성
