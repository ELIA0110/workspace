...
public class CarRun {
	public static void main(String[] args) {
		...
		// 부모 참조 변수 = 자식 객체 생성
		Car c2 = new Porsche(); // 오잉 왜 에러가 발생안하지?
		...
		for (int i = 0; i < 6; i++) { // ctrl + shift + f : 자동 정렬 (정확도가 높진 않다)
			...
			if (car1 != null) {// 인덱스 정상 범위
				...
				// Porsche 참조 변수 = Spark 객체 -> 부모 자식이 아니니까 다형성 적용 X
