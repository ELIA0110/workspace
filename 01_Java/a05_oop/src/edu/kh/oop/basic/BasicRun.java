 ...
 * 
 * - Java : 클래스에 작성된 내용을 토대로 new 연산자에 의해 Heap 메모리에 생성되는 것
 * 
 * 
 * 클래스(class)란?
...
public class BasicRun {
	...
	public static void main(String[] args) {
		...
		/* 1) Nation n1 : Nation 객체 참조변수 n1을 선언(주소 저장)
		 * 2) new : Heap 영역에 새롭게 할당(생성)
		 * 3) new Nation() : Nation 클래스를 이용해서 Heap 영역에 
		 * 				     Nation 객체를 생성(메모리 할당)
		 *					 -> 할당된 메모리의 시작 주소가 반환됨	 
		 * 
		 * 4) Nation n1 = new Nation();
		 *   --> Nation 참조 변수 n1에 Heap에 새로 생성된 Nation 객체의 주소를 대입
		 *     
		 */
		
		// n1 == Nation 객체를 참조하는 변수 == Nation 객체를 의미
...
//		n1.job = "국정원 비밀요원";
		// The field Nation.job is not visible : job 변수가 안보인다.
