...
public class Calculator {
	...
	// saveValue의 setter
	public void setSaveValue(double saveValue) { // 반환할게 없어서 void
		this.saveValue = saveValue;
	}
	
	// saveValue의 getter
	public double getSaveValue() { // saveValue의 자료형이 double이라 double이 들어간다.
		return saveValue;
	}
	...
	public double div(double number) {
		...
		if(number == 0) { // 전달 받은 값이 0일 경우
			saveValue = 0;
			return saveValue;
			// 0인 경우 saveValue를 0으로 만든 후 0 return 후 메서드 종료
		}
		// number가 0이 아닌 경우
