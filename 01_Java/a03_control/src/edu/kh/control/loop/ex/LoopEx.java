...
public class LoopEx {
	...
	// for 예제 4 - 2부터 20 까지 2씩 증가해서 출력하기
	public void ex4() {
	...
	// for 예제 6 - 50부터 100 까지의 모든 정수의 합 출력
	public void ex6() {
		int sum = 0;
	...
	public void ex8() {
		...
		for(int i = start; i <= end; i += step) {
			System.out.print(i + " "); // 옆으로 한 칸 씩 띄워서 출력
			sum += i;
		}
		System.out.println("\n합계 : " + sum);
	}
	
	// 예제 9  - 1부터 10까지 모든 정수 출력
	// 단, 짝수는 []로 감싸서 출력
	...
	// 예제 11 - 1부터 20까지 1씩 증가하는 반복문을 이용해 
	// 짝수의 합, 홀수의 합을 구해서 출력
	public void ex11() {
	...
	// 예제 12 - 1부터 100까지 1씩 증가하는 반복문을 이용
	// 1 ~ 100 사이 수 중 입력 받을 수의 배수를 뺀 나머지 수의 합을 출력
	public void ex12() {
		Scanner sc = new Scanner(System.in);
		int sum = 0;
		int num = sc.nextInt();
