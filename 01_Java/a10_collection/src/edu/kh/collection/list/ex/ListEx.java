...
//		List list = new ArrayList(); // 10칸 짜리 생성
		...
		System.out.println(list.get(1) instanceof Double); // false
		...
		for(int i=0 ; i<list.size(); i++) {
			...
			if(list.get(i) instanceof String) { // i번째 요소가 String
				String s = (String)list.get(i); // 다운 캐스팅(list는 다 저장할 수 있는 object이니까)
	...
	public void ex2() {
		...
		// Generics : 컬렉션이 다룰 클래스 타입을 제한하여 한 가지 종류의 클래스만 저장할 수 있게 하는 기능
