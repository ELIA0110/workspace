...
public class MapEx {
	 ...
	 *   	* key 역할을 하는 객체에는 equals(), hashcode()가 오버라이딩 되어있어야 한다!
	 *   
	 *   2) 순서 유지 X
	...
	public void ex1() {
		...
		//    Map에 추가 시 K가 중복되면 새로운 Value로 덮어 씌우고
		//    이전 Value가 반환된다. 
		//    중복 아니면 null 반환
		...
		System.out.println(map.remove(5) + " 제거");
	...
	public void ex2() {
		...
		// 1. map.keySet() : Key만을 모아놓은 집합(Set)을 반환
		...
		// 2. ketSet을 이용해서 Map에 있는 모든 요소 순차 접근
	...
	public void ex3() {
		...
		// 1) 한 번에 많은 양의 데이터를 명확하게 구분할 수 있는 형태로 
		//	  전달해야되는 경우
